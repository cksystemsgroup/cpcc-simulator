...
{
    private static final Logger LOG = LoggerFactory.getLogger(EngMapServlet.class);
    ...
    public void init(ServletConfig servletConfig) throws ServletException
    {
        ...
        regdata = new ConcurrentSkipListMap<>();
        centralEngines = new ConcurrentSkipListSet<>();
        neighborZones = new ConcurrentSkipListSet<>();
        super.init();
        myInit();
    }
    ...
    public void reloadConfigFile() throws IOException
    {
        ...
        LOG.info("Loading configuration from {}", configFile);
        List<IMappingAlgorithm> algorithms = new ArrayList<>();
