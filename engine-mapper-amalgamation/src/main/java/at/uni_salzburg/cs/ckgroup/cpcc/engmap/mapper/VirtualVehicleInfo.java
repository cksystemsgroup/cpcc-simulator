...
{
    static final Map<String, String> actionsMap = Collections.unmodifiableMap(Stream.of(
        ...
        Pair.of("SONAR", "sonar"),
        Pair.of("SPEED", "speed"),
        Pair.of("TEMPERATURE", "temperature")).collect(Collectors.toMap(Pair::getLeft, Pair::getRight)));
