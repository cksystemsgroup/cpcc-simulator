...
public class AirPressure extends AbstractAction
{
    ...
    {
        return null != (value = sprox.getSensorValueAsDouble(ISensorProxy.SENSOR_NAME_AIR_PRESSURE));
    }
    ...
    public String toString()
    {
        if (isComplete())
        {
            return String.format(Locale.US, "AirPressure (%d, %.1f)", getTimestamp(), value);
        }
        return "AirPressure";
    }
