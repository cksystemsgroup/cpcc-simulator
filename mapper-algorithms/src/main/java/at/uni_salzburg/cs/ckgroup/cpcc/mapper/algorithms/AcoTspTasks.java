...
public class AcoTspTasks {
	 ...
	 */
	public AcoTspTasks(IGeodeticSystem geodeticSystem) {
	 ...
	 *         distance.
	 */
	public List<ITask> calculateBestPathWithDepot(List<ITask> path) {
		...
		List<ITask> r = new ArrayList<ITask>();
	 ...
	 *         distance.
	 */
	public List<ITask> calculateBestPathWithOutDepot(List<ITask> path) {
