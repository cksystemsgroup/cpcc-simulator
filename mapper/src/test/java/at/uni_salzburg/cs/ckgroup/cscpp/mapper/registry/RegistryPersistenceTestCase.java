/*
 * @(#) Configuration.java This code is part of the CPCC project. Copyright (c) 2011 Clemens Krainer This program is
...
public class RegistryPersistenceTestCase
{
    ...
    public void test() throws Exception
    {
        ...
        JSONAssert.assertEquals(EXPECTED_JSON, wayPoint.toJSONString(), false);

        // Assert.assertEquals(EXPECTED_JSON, wayPoint.toJSONString());
