...
%\onehalfspacing
\begin{abstract}
For the hands-on part of the Embedded Software Engineering Course, Winter 2011/2012 (Department of Computer Sciences,
University of Salzburg) we decided to 
build a simulation system that demonstrates information-acquisition-as-a-service
of mobile sensor networks for \acl{CPCC}.
...
describes vehicle virtualzation, and pictures cyber-mobility.
%
Third, it elaborates on the class demonstrations, which exemplity data collection, vehicle migration, and varying sensor
equipment.
%
Finally, this work summarises this paper and depicts proposals for future enhancements.
\end{abstract}
